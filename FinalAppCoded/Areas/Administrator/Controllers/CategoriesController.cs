...
namespace FinalAppCoded.Areas.Administrator.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,Name,Description,CategoryImg")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,Name,Description,CategoryImg")] Category category)
        {
